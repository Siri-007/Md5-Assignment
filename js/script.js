...
(function(global) {
    ...
    dc.loadMenuCategories = function() {
        ...
        $ajaxUtils.sendGetRequest
        homeHtmlUrl,
        buildAndShowhomeHtmlUrl, true // Explicitly setting the flag to get JSON from server processed into an object literal
    };

    function buildAndShowhomeHtmlUrl(chooseRandomCategory) {
                ...
                $ajaxUtils.sendGetRequest(
                    ...
                    function(chooseRandomCategory) {
                        var chosenCategoryShortName =
                            buildchosenCategoryShortNameHtml(chooseRandomCategory,
                                categoriesTitleHtml,
                                categoryHtml,
                                homeHtmlUrl);
    ...
    dc.loadMenuItems('L') = function(ChooseRandomCategory) {
        ...
        $ajaxUtils.sendGetRequest(
            ChooseRandomCategory,
            buildAndShowChooseRandomCategory);
